...
const typeNum = (arr) => {
  // Solution code here...
  let numbersOnly=(vlue)=>{
    if(typeof(vlue)==='number'){
      return vlue;
    }
  }
  let num=arr.filter(numbersOnly)
  return num;
  }
...
const containsAnd = (arr) => {
  // Solution code here...
  let key = 'and',
    filtered = arr.filter(function (str) { return str.includes(key); })
    return filtered;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let array2=arr;
  let array1=forbiddenValues;
  let tempArr = array2.filter(function(item) {
